...
switch ($accion) {
  ...
  $sentenciaSQL= $conexion->prepare("INSERT INTO computadora (id,madre,procesador,ram,observacion,id_u) VALUES (:id,:madre,:procesador,:ram,:observacion,:id_u);");
  ...
  $sentenciaSQL->bindParam(':id_u', $id_u);
...
$sentenciaSQL= $conexion->prepare("SELECT * FROM computadora WHERE id_u = :id_u");
$sentenciaSQL->bindParam(":id_u", $id_u, PDO::PARAM_INT);
$sentenciaSQL->execute();
